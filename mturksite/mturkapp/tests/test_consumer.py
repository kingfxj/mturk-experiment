'''
code reference https://github.com/hishnash/djangochannelsrestframework/blob/master/tests/test_consumer.py#L27
need to pip install djangochannelsrestframework
'''
